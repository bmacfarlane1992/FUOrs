...
#
		...
		m_d_piv = [] ; r_d_sigALMA = [] ; m_d_sigALMA = []
		snap = [] ; acctag_num = [] ; acctag = []
#
	# Loop over lines and store variables in arrays
#
		f = open(filename, 'r')
		for line in f:
			line = line.strip()
...
#
			if (columns[14] != "*"):
				acctag_num.append(columns[14])
			else:
				acctag_num.append(float(0))
#
			acctag.append(columns[15])
#
		f.close()
#
#
...
#	
		plt.savefig(plotdir+'iad_star_mass.png')
		plt.clf()
#
...
#
		...
		plt.savefig(plotdir+'disc_mass.png')	
		plt.clf()
#
...
#
		...
		plt.savefig(plotdir+'disc_radius.png')	
		plt.clf()
#
...
#
			...
			plt.ylim(0, ax1.get_ylim()[1])
			plt.ylabel("disc mass "+(r'(M$_{\odot}$)'))
			plt.savefig(plotdir+'trestr_disc_mass.png')	
			plt.clf()
#
...
#
			...
			plt.ylim(0, ax1.get_ylim()[1])
			plt.ylabel("disc radius (AU)")
			plt.savefig(plotdir+'trestr_disc_radius.png')	
			plt.clf()
#
#
# = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
...
#
		...
		r_d_kep = 0 ; acc_count = 0 ; acctag_num = 0 ; hasharr_app = 0 ; n_accr = 0
#
#
# = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
...
#
	...
	for line in f:
		line = line.strip()
		columns = line.split()
		m_s.append(float(columns[1])) ; m_d_kep.append(float(columns[4]))
